...
namespace cliente_aspnetcore_iroxit.Web.Controllers
{
    public class VentasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDVentas,IDProductos,CantidadVendida,Fecha")] Ventas ventas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDVentas,IDProductos,CantidadVendida,Fecha")] Ventas ventas)
        {
